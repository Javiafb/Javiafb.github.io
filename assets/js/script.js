document.addEventListener("DOMContentLoaded", function () {
  ...
  // URL de la API de GitHub para obtener la información del usuario
  const githubAPIUrl = `https://api.github.com/users/${githubUsername}?callback=processResponse`;

  // Variable para controlar si se ha completado la carga de la imagen
  ...
  function handleTimeout() {
    // Si la imagen aún no se ha cargado, mostrar un mensaje de error
    if (!imageLoaded) {
    ...
    //  poner imagen por defecto
      ...
      //  let imagen_erro =  document.getElementById("github-avatar").src = "error.png";
       // Cambia "error.png" por la imagen de error que desees mostrar
      // document.getElementById("error-message").style.display = "block";

    } 
  }

  // Agregar una función de callback para procesar la respuesta
